...
NSNotificationName const kChangeDefaultURLNotification = @"kChangeDefaultURLNotification";
...
{
  NSUserDefaults* defaults = [NSUserDefaults standardUserDefaults];
  [defaults setValue:defaultURL.absoluteString forKey:@"defaultURL"];
  [defaults synchronize];
  [[NSNotificationCenter defaultCenter] postNotificationName:kChangeDefaultURLNotification object:defaultURL];
}
